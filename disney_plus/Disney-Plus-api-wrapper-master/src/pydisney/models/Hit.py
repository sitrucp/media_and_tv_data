...
class Hit(ABC):
    def __init__(self, data):
        ...
        self.personalization_pid = safe_get(data, ["personalization", "pid"])
    ...
    def _get_more_data(self) -> None:
        ...
        # Try to get personalization_pid at the top level if present
        self.personalization_pid = safe_get(res["data"]["page"], ["personalization", "pid"])
